...
export const internalRoleDirectory: InternalRoleEntry[] = [
  ...
  { email: "rcumberbatch@costaatt.edu.tt", name: "Rhonda Cumberbatch", roles: ["registry_admin"], department: "Registry" },
  { email: "gking@costaatt.edu.tt", name: "Gwyneth King", roles: ["registry_admin"], department: "Registry" },
  { email: "nthomas@costaatt.edu.tt", name: "Nigel Thomas", roles: ["registry_staff"], department: "Registry" },
  ...
  { email: "kbanfield@costaatt.edu.tt", name: "Kempson Banfield", roles: ["registry_staff"], department: "Registry" },
